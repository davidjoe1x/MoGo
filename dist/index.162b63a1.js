!function($) {
    return $ ? ($.Unslider = function(t, n) {
        ...
        return e._ = "unslider", e.defaults = {
            ...
            return e.options = $.extend({}, e.defaults, t), e.$container = e.$context.find(e.options.selectors.container).addClass(e.prefix + "wrap"), e.$slides = e.$container.children(e.options.selectors.slides), e.setup(), $.each([
                "nav",
                "arrows",
                "keys",
                "infinite"
            ...
            e.options.autoplay && e.stop().start(), e.setIndex(t), e.$context.trigger(e._ + ".change", [
                t,
                e.$slides.eq(t)
            ]);
...
//# sourceMappingURL=index.162b63a1.js.map
